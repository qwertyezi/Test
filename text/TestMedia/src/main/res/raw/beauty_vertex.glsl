...
void main( )
{
    ...
    vBlurCoord1s[0] = vTextureCoordinate + vec2( 0.0 * mul_x, -10.0 * mul_y );
    vBlurCoord1s[1] = vTextureCoordinate + vec2( 8.0 * mul_x, -5.0 * mul_y );
    vBlurCoord1s[2] = vTextureCoordinate + vec2( 8.0 * mul_x, 5.0 * mul_y );
