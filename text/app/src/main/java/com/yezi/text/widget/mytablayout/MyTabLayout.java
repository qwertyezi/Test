...
package com.yezi.text.widget.mytablayout;
...
public class MyTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link MyTabLayout} as much as possible. This option only takes effect
     ...
     * necessary calls back to the provided {@link MyTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    /**
     * A {@link MyTabLayout.OnTabSelectedListener} class which contains the necessary calls back
